...
!function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define("tctip", [], e) : "object" == typeof exports ? exports.tctip = e() : t.tctip = e()
} (this,
function() {
    return function(t) {
        function e(r) {
        ...
        l = function(t) {
            ...
            a(e, [{
                ...
                value: function(t, e) {
                    ...
                    return this._dom = (0, s.createElement)(t, e),
    ...
    function(t, e, n) {
        ...
        function i(t, e) {
            ...
            for (var r in t) if ("style" !== r) n[r] = t[r];
            else for (var i in t[r]) n.style[i] = t[r][i];
            return n
        }
        function o(t, e) {
            return e = e || document,
            e.getElementsByClassName ? e.getElementsByClassName(t) : function(t, e) {
                var n = [],
    ...
    function(t, e, n) {
        ...
        function i(t) {
            t.button || (t.button = s);
            var e = t.button;
            e.imageUrl || (e.id || (e.id = s.id), e.type && (0, A.inArray)(e.type, u) || (e.type = s.type), e.imageUrl = l[e.type][e.id], delete e.type, delete e.id)
        }
        function o(t) {
            ...
            try {
                for (var a, c = t.list[Symbol.iterator](); ! (r = (a = c.next()).done); r = !0) {
                    ...
                    var s = u.type;
                    if (f.hasOwnProperty(s) && (0, A.mergeObject)(u, f[s], !0), n ? u.active = "": u.active && (n = !0), u.index = e.length, e.push(u), e.length >= 5) break
                }
            } catch(t) {
                i = !0,
                o = t
            ...
            },
            {
                ...
                get: function() {
                    if (!this._currentItem) {
                        ...
                        n = void 0;
                        try {
                            for (var r, i = this.config.list[Symbol.iterator](); ! (t = (r = i.next()).done); t = !0) {
                                var o = r.value;
    ...
    function(t, e) {
        ...
        n.prototype.addListener = function(t, e) {
            ...
            o(this._events[t]) && !this._events[t].warned && (i = A(this._maxListeners) ? n.defaultMaxListeners: this._maxListeners, i && i > 0 && this._events[t].length > i && (this._events[t].warned = !0, console.error("(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.", this._events[t].length), "function" == typeof console.trace && console.trace())),
            this
        },
        ...
        n.prototype.removeListener = function(t, e) {
            ...
            if (n = this._events[t], A = n.length, i = -1, n === e || r(n.listener) && n.listener === e) delete this._events[t],
        ...
        var r, i, o, A = function() {
            function t(e, n) {
                ...
                i.multiply = function(e) {
                    for (var n = new Array(i.getLength() + e.getLength() - 1), r = 0; r < i.getLength(); r += 1) for (var o = 0; o < e.getLength(); o += 1) n[r + o] ^= A.gexp(A.glog(i.getAt(r)) + A.glog(e.getAt(o)));
                    return t(n, 0)
                },
                i.mod = function(e) {
            ...
            var e = function(e, n) {
                ...
                w = function(t, e) {
                    for (var n = -1; n <= 7; n += 1) if (! (t + n <= -1 || d <= t + n)) for (var r = -1; r <= 7; r += 1) e + r <= -1 || d <= e + r || (g[t + n][e + r] = 0 <= n && n <= 6 && (0 == r || 6 == r) || 0 <= r && r <= 6 && (0 == n || 6 == n) || 2 <= n && n <= 4 && 2 <= r && r <= 4)
                },
                I = function() {
                    for (var t = 0,
                    e = 0,
                    n = 0; n < 8; n += 1) {
                        E(!0, n);
                        var r = o.getLostPoint(m); (0 == n || t > r) && (t = r, e = n)
                    }
                    return e
                },
                R = function() {
                ...
                M = function() {
                    for (var t = o.getPatternPosition(p), e = 0; e < t.length; e += 1) for (var n = 0; n < t.length; n += 1) {
                        var r = t[e],
                        i = t[n];
                        if (null == g[r][i]) for (var A = -2; A <= 2; A += 1) for (var a = -2; a <= 2; a += 1) g[r + A][i + a] = A == -2 || 2 == A || a == -2 || 2 == a || 0 == A && 0 == a
                    }
                },
                D = function(t) {
                ...
                B = function(t, e) {
                    for (var n = h << 3 | e,
                    r = o.getBCHTypeInfo(n), i = 0; i < 15; i += 1) {
                        var A = !t && 1 == (r >> i & 1);
                        i < 6 ? g[i][8] = A: i < 8 ? g[i + 1][8] = A: g[d - 15 + i][8] = A
                    }
                    for (var i = 0; i < 15; i += 1) {
                        var A = !t && 1 == (r >> i & 1);
                        i < 8 ? g[8][d - i - 1] = A: i < 9 ? g[8][15 - i - 1 + 1] = A: g[8][15 - i - 1] = A
                    }
                    g[d - 8][8] = !t
                },
                k = function(t, e) {
                    ...
                    i = 7,
                    A = 0,
                    a = o.getMaskFunction(e), c = d - 1; c > 0; c -= 2) for (6 == c && (c -= 1);;) {
                ...
                j = function(e, n) {
                    ...
                    i = 0,
                    A = 0,
                    a = new Array(n.length), c = new Array(n.length), u = 0; u < n.length; u += 1) {
                        var s = n[u].dataCount,
                        l = n[u].totalCount - s;
                        i = Math.max(i, s),
                        A = Math.max(A, l),
                    ...
                    for (var b = 0,
                    f = 0; f < n.length; f += 1) b += n[f].totalCount;
                    for (var y = new Array(b), v = 0, f = 0; f < i; f += 1) for (var u = 0; u < n.length; u += 1) f < a[u].length && (y[v] = a[u][f], v += 1);
                    for (var f = 0; f < A; f += 1) for (var u = 0; u < n.length; u += 1) f < c[u].length && (y[v] = c[u][f], v += 1);
                    return y
                },
                U = function(t, e, n) {
                    ...
                    for (var f = 0,
                    s = 0; s < r.length; s += 1) f += r[s].dataCount;
                ...
                m.createSvgTag = function(t, e) {
                    t = t || 2,
                    e = void 0 === e ? 4 * t: e;
                    var n, r, i, o, A, a = m.getModuleCount() * t + 2 * e,
                    c = "";
                    for (A = "l" + t + ",0 0," + t + " -" + t + ",0 0,-" + t + "z ", c += "<svg", c += ' width="' + a + 'px"', c += ' height="' + a + 'px"', c += ' xmlns="http://www.w3.org/2000/svg"', c += ">", c += '<path d="', i = 0; i < m.getModuleCount(); i += 1) for (o = i * t + e, n = 0; n < m.getModuleCount(); n += 1) m.isDark(i, n) && (r = n * t + e, c += "M" + r + "," + o + A);
                    return c += '" stroke="transparent" fill="black"/>',
                    c += "</svg>"
                },
            ...
            o = function() {
                ...
                a.getLostPoint = function(t) {
                    for (var e = t.getModuleCount(), n = 0, r = 0; r < e; r += 1) for (var i = 0; i < e; i += 1) {
                        for (var o = 0,
                        A = t.isDark(r, i), a = -1; a <= 1; a += 1) if (! (r + a < 0 || e <= r + a)) for (var c = -1; c <= 1; c += 1) i + c < 0 || e <= i + c || 0 == a && 0 == c || A == t.isDark(r + a, i + c) && (o += 1);
                        o > 5 && (n += 3 + o - 5)
                    }
                    ...
                    for (var r = 0; r < e; r += 1) for (var i = 0; i < e - 6; i += 1) t.isDark(r, i) && !t.isDark(r, i + 1) && t.isDark(r, i + 2) && t.isDark(r, i + 3) && t.isDark(r, i + 4) && !t.isDark(r, i + 5) && t.isDark(r, i + 6) && (n += 40);
                    for (var i = 0; i < e; i += 1) for (var r = 0; r < e - 6; r += 1) t.isDark(r, i) && !t.isDark(r + 1, i) && t.isDark(r + 2, i) && t.isDark(r + 3, i) && t.isDark(r + 4, i) && !t.isDark(r + 5, i) && t.isDark(r + 6, i) && (n += 40);
                    for (var s = 0,
                    i = 0; i < e; i += 1) for (var r = 0; r < e; r += 1) t.isDark(r, i) && (s += 1);
                    return n += 10 * (Math.abs(100 * s / e / e - 50) / 5)
                },
                a
            } (),
            A = function() {
            ...
            a = function() {
                ...
                return n.getRSBlocks = function(t, n) {
                    var r = i(t, n);
                    if (void 0 === r) throw new Error("bad rs block @ typeNumber:" + t + "/errorCorrectionLevel:" + n);
                    for (var o = r.length / 3,
                    A = new Array,
                    a = 0; a < o; a += 1) for (var c = r[3 * a + 0], u = r[3 * a + 1], s = r[3 * a + 2], l = 0; l < c; l += 1) A.push(e(u, s));
                    return A
                },
                n
            } (),
            ...
            u = function(t) {
                ...
                i.write = function(t) {
                    for (var e = r,
                    n = 0; n + 2 < e.length;) t.put(o(e.substring(n, n + 3)), 10),
                    n += 3;
                    n < e.length && (e.length - n == 1 ? t.put(o(e.substring(n, n + 1)), 4) : e.length - n == 2 && t.put(o(e.substring(n, n + 2)), 7))
                };
                var o = function(t) {
                    for (var e = 0,
                    n = 0; n < t.length; n += 1) e = 10 * e + A(t.charAt(n));
                    return e
                },
                A = function(t) {
            ...
            s = function(t) {
                ...
                i.write = function(t) {
                    for (var e = r,
                    n = 0; n + 1 < e.length;) t.put(45 * o(e.charAt(n)) + o(e.charAt(n + 1)), 11),
                    n += 2;
            ...
            p = function() {
                ...
                e.toString = function() {
                    var e = "";
                    e += "[";
                    for (var n = 0; n < t.length; n += 1) n > 0 && (e += ","),
                    e += t[n];
                    return e += "]"
                },
                e
            ...
            h = function() {
                ...
                return i.writeByte = function(r) {
                    for (t = t << 8 | 255 & r, e += 8, n += 1; e >= 6;) o(t >>> e - 6),
                    e -= 6
                },
                i.flush = function() {
                    if (e > 0 && (o(t << 6 - e), t = 0, e = 0), n % 3 != 0) for (var i = 3 - n % 3,
                    A = 0; A < i; A += 1) r += "="
                },
                i.toString = function() {
                    return r
            ...
            d = function(t, e) {
                ...
                o.write = function(t) {
                    ...
                    i = a(e);
                    t.writeByte(e);
                    for (var o = 0; i.length - o > 255;) t.writeByte(255),
                ...
                var A = function(t) {
                    ...
                    return i.write = function(t, i) {
                        ...
                        for (; n + i >= 8;) e.writeByte(255 & (t << n | r)),
                        i -= 8 - n,
                        t >>>= 8 - n,
                        r = 0,
                        n = 0;
                ...
                a = function(t) {
                    for (var e = 1 << t,
                    n = (1 << t) + 1, r = t + 1, o = c(), a = 0; a < e; a += 1) o.add(String.fromCharCode(a));
                    ...
                    for (l += 1; l < i.length;) {
                        ...
                        l += 1,
                        o.contains(f + h) ? f += h: (s.write(o.indexOf(f), r), o.size() < 4095 && (o.size() == 1 << r && (r += 1), o.add(f + h)), f = h)
                    }
                    return s.write(o.indexOf(f), r),
                    s.write(n, r),
                    s.flush(),
                    u.toByteArray()
                },
            ...
            b = function(t, e, n, r) {
                for (var i = d(t, e), o = 0; o < e; o += 1) for (var A = 0; A < t; A += 1) i.setPixel(A, o, n(A, o));
                var a = p();
                i.write(a);
    ...
    function(t, e) {
        ...
        function c(t, e) {
            ...
            if (e.singleton) {
                ...
                r = u.bind(null, n, c, !1),
                i = u.bind(null, n, c, !0)
            } else t.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (n = a(e), r = l.bind(null, n), i = function() {
                o(n),
    ...
    function(t, e, n) {
        ...
        b = function(t) {
            ...
            a(e, [{
                key: "formatConfig",
                value: function() { (0, u.formatConfig)(this._config)
                }
            },
            {
                key: "getTctipDom",
